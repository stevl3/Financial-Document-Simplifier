...
export default function Navigation() {
  ...
  const navItems = [
    ...
    {
      href: "https://github.com/stevl3/financial-document-simplifier",
      label: "GitHub",
      icon: Github,
      external: true,
    },
    ...
    <nav className="bg-card-bg shadow-sm border-b border-primary-accent/20">
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <Link
            href="/"
            className="flex items-center space-x-2 font-heading text-xl text-primary-text"
          >
              ...
              return (
                <Link
                  ...
                  className={`flex items-center space-x-1 transition-colors font-body-medium ${
                    isActive
                      ? "text-button-primary font-subheading"
